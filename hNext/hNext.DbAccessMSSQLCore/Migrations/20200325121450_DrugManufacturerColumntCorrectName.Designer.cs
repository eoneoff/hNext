...
namespace hNext.DbAccessMSSQLCore.Migrations
{
    ...
    [Migration("20200325121450_DrugManufacturerColumntCorrectName")]
    partial class DrugManufacturerColumntCorrectName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hNext.Model.CaseHistoryPrescription", b =>
                {
                    ...
                    b.HasKey("CaseHistoryId", "PrescriptionId");

                    b.ToTable("CaseHistoryPrescriptions");
                });
            ...
            modelBuilder.Entity("hNext.Model.Drug", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("hNext.Model.Prescription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("Prescription");
                });
            ...
            modelBuilder.Entity("hNext.Model.RecordDiagnosys", b =>
                {
            ...
            modelBuilder.Entity("hNext.Model.RecordPrescription", b =>
                {
                    b.Property<long>("RecordId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("RecordId", "PrescriptionId");

                    b.HasIndex("PrescriptionId");

                    b.ToTable("RecordPrescriptions");
                });
            ...
            modelBuilder.Entity("hNext.Model.DrugPrescription", b =>
                {
                    b.HasBaseType("hNext.Model.Prescription");
                    ...
                    b.HasDiscriminator().HasValue("DrugPrescription");
                });
            ...
            modelBuilder.Entity("hNext.Model.CaseHistoryPrescription", b =>
                {
                    ...
                    b.HasOne("hNext.Model.Prescription", "Prescription")
                        .WithMany("CaseHistories")
                        .HasForeignKey("CaseHistoryId")
            ...
            modelBuilder.Entity("hNext.Model.PatientDiagnosys", b =>
                {
                    ...
                    b.HasOne("hNext.Model.Record", "Records")
                        .WithMany()
