...
{
    [TestClass]
    public class RecordFieldTemplateEditorViewComponentTests
    {
        private RecordFieldTemplateEditorViewComponent component = new RecordFieldTemplateEditorViewComponent();
